...
-- RUN_SCHEDULE
INSERT INTO RUN_SCHEDULE (SCHEDULE_CODE, THEATER_CODE, MOVIE_CODE, RUN_DATE, START_TIME, END_TIME, PRICE, DISCOUNTRATE)
VALUES
('S001', 'T00001', 'M001', '2025-10-15', '14:00', '16:00', 10000, 0);

-- RESERVATION
INSERT INTO RESERVATION (RESERVE_CODE, RESERVE_DATE, USER_ID, THEATER_CODE, MOVIE_CODE, SEAT_CODE, PRICE, SCHEDULE_CODE)
VALUES
('R001', '2024-05-20', 'user', 'T00001', 'M001', 'A1', 10000, 'S001');
...
-- ORDER_HISTORY
INSERT INTO ORDER_HISTORY (ORDER_CODE, USER_ID, MOVIE_CODE, PRICE, ORDER_DATE, ORDER_TYPE)
VALUES
('O001', 'user', 'M001', 12000, '2024-05-21', 'RESERVATION'),
('O002', 'user', 'M001', 15000, '2024-05-25', 'VOD'),
('O003', 'vip',  'M001', 10000, '2024-06-01', 'RESERVATION'),
('O004', 'vip',  'M001', 18000, '2024-06-05', 'VOD'),
('O005', 'user', 'M001', 12000, '2024-06-10', 'RESERVATION'),
('O006', 'vip',  'M001', 16000, '2024-06-12', 'RESERVATION'),
('O007', 'user', 'M001', 15000, '2024-06-15', 'VOD'),
('O008', 'vip',  'M001', 18000, '2024-06-20', 'VOD'),
('O009', 'user', 'M001', 11000, '2024-06-22', 'RESERVATION'),
('O010', 'vip',  'M001', 19000, '2024-06-25', 'RESERVATION');
...
VALUES
('T00001','서비스이용약관','제1조(목적) 이 약관은 "NOT404" 회사(전자상거래 사업자)가 운영하는 "NOT404CINEMA"
