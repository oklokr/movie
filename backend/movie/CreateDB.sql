...
CREATE TABLE TERMS(
TERMS_CODE VARCHAR(50) PRIMARY KEY,
TERMS_TITLE VARCHAR(300) NOT NULL,
TERMS_CONTENT VARCHAR(3000) NOT NULL,
...
ADULT CHAR(1) NOT NULL DEFAULT 'N',
...
CREATE TABLE GENRE(
GENRE_CODE VARCHAR(50) PRIMARY KEY,
GENRE_NAME VARCHAR(50) NOT NULL
);

CREATE TABLE CREATOR(
CREATOR_CODE VARCHAR(50) PRIMARY KEY,
...
CREATE TABLE MOVIE(
MOVIE_CODE VARCHAR(50) PRIMARY KEY,
GENRE_CODEA VARCHAR(50) NOT NULL,
GENRE_CODEB VARCHAR(50),
GENRE_CODEC VARCHAR(50),
MOVIE_NAME VARCHAR(100) NOT NULL,
DIRECT_CODEA VARCHAR(50) NOT NULL,
DIRECT_CODEB VARCHAR(50),
ACTOR_CODEA VARCHAR(50) NOT NULL,
ACTOR_CODEB VARCHAR(50),
ACTOR_CODEC VARCHAR(50),
ACTOR_CODED VARCHAR(50),
ACTOR_CODEE VARCHAR(50),
...
SALES INT DEFAULT 0,
PRICE INT DEFAULT 0 DEFAULT 10000,
DISCOUNTRATE INT DEFAULT 0,
VOD_STATE CHAR(1) NOT NULL DEFAULT "Y",
RESERVATION_STATE CHAR(1) NOT NULL DEFAULT "N",
...
THEATER_CODE VARCHAR(50) PRIMARY KEY,
THEATER_NAME VARCHAR(20) NOT NULL
);

CREATE TABLE RUN_SCHEDULE(
SCHEDULE_CODE VARCHAR(50) PRIMARY KEY,
...
DISCOUNTRATE TINYINT NOT NULL DEFAULT 0,
...
RESERVE_CODE VARCHAR(50) PRIMARY KEY,
...
CONSTRAINT RESERVE_SCHEDULECODE_FK FOREIGN KEY (SCHEDULE_CODE) REFERENCES RUN_SCHEDULE(SCHEDULE_CODE)
);

CREATE TABLE RESERVATION_SEAT (
    RESERVE_SEAT_CODE VARCHAR(50) PRIMARY KEY,
    RESERVE_CODE VARCHAR(50) NOT NULL,
    SEAT_ROW CHAR(1) NOT NULL,
    SEAT_NUM INT NOT NULL,
    CREATE_DATE DATETIME DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT RESERVE_SEAT_FK FOREIGN KEY (RESERVE_CODE) REFERENCES RESERVATION(RESERVE_CODE)
);

CREATE TABLE SEAT (
    SEAT_CODE VARCHAR(50) PRIMARY KEY,
    THEATER_CODE VARCHAR(50) NOT NULL,
    SEAT_ROW CHAR(1) NOT NULL,
    SEAT_NUM INT NOT NULL,
    CONSTRAINT SEAT_THEATER_FK FOREIGN KEY (THEATER_CODE) REFERENCES THEATER(THEATER_CODE)
);
...
CREATE TABLE NOTICE(
NOTICE_CODE VARCHAR(50) PRIMARY KEY,
CATEGORY VARCHAR(50),
...
CREATE TABLE FAQ(
FAQ_CODE VARCHAR(50) PRIMARY KEY,
QUESTION VARCHAR(300) NOT NULL,
ANSWER VARCHAR(500) NOT NULL
);

CREATE TABLE QNA(
QNA_CODE VARCHAR(50) PRIMARY KEY,
